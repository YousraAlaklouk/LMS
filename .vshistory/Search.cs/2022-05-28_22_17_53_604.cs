...
namespace LibraryManegement
{
    public partial class Search : Form
    {
        ...
        {
            var Title = BCollection.Find(x => x.TITLE == txtSearch.Text.Trim().ToString());
            var Author= BCollection.Find(x => x.AUTHOR_ID == txtSearch.Text.Trim().ToString());
            var Publisherid = BCollection.Find(x => x.PUBLISHER_ID == txtSearch.Text.Trim().ToString());
            var Cat = BCollection.Find(x => x.CAT_ID == txtSearch.Text.Trim().ToString());
        }
