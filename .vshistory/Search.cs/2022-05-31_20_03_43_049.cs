...
namespace LibraryManegement
{
    public partial class Search : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            var builder = Builders<AddBook1>.Filter;/*.Eq(a => a.TITLE, "^" + txtSearch.Text.ToString()+ "$");*/
            /*            var filtirDefinition2 = Builders<AddBook1>.Filter.Eq(a => a.AUTHOR_ID, txtSearch.Text.ToString());
             *            
            */
            var filter = builder.Regex("TITLE", queryExpr); ;
