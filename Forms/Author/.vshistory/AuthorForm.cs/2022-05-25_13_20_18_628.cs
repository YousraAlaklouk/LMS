...
/*
        ...
        private void btnUpdateAuthor_Click(object sender, EventArgs e)
        {
            ...
            if (txtboxAuthorName.Text == string.Empty || txtboxAuthorSurname.Text == string.Empty || txtboxAuthorNationality.Text == string.Empty)
            {
                try
                {
                    var filterDefinition = Builders<AddAuthor>.Filter.Eq(a => a.Id, dataGridViewAuthor.CurrentRow.Cells[0].Value);
            ...
            else if (txtboxAuthorSurname.Text == string.Empty || txtboxAuthorNationality.Text == string.Empty || txtboxAuthorEmail.Text == string.Empty)
            {
                try
                {
                    var filterDefinition = Builders<AddAuthor>.Filter.Eq(a => a.Id, dataGridViewAuthor.CurrentRow.Cells[0].Value);
            ...
            else if (txtboxAuthorName.Text == string.Empty || txtboxAuthorNationality.Text == string.Empty || txtboxAuthorEmail.Text == string.Empty)
            {
                try
                {
                    var filterDefinition = Builders<AddAuthor>.Filter.Eq(a => a.Id, dataGridViewAuthor.CurrentRow.Cells[0].Value);
            ...
            else if (txtboxAuthorName.Text == string.Empty || txtboxAuthorSurname.Text == string.Empty || txtboxAuthorEmail.Text == string.Empty)
            {
                try
                {
                    var filterDefinition = Builders<AddAuthor>.Filter.Eq(a => a.Id, dataGridViewAuthor.CurrentRow.Cells[0].Value);
            ...
            else if (txtboxAuthorName.Text == string.Empty || txtboxAuthorSurname.Text == string.Empty || txtboxAuthorNationality.Text == string.Empty || txtboxAuthorEmail.Text == string.Empty)
            {
                try
                {
                    var filterDefinition = Builders<AddAuthor>.Filter.Eq(a => a.Id, dataGridViewAuthor.CurrentRow.Cells[0].Value);
