...
/*
        ...
        private void btnUpdateAuthor_Click(object sender, EventArgs e)
        {
            ...
            if (txtboxAuthorSurname.Text == string.Empty && txtboxAuthorNationality.Text == string.Empty && txtboxAuthorEmail.Text == string.Empty)
            {
                try
                {
            ...
            else if (txtboxAuthorName.Text == string.Empty && txtboxAuthorSurname.Text == string.Empty && txtboxAuthorNationality.Text == string.Empty)
            {
                try
                {
                    var filterDefinition = Builders<AddAuthor>.Filter.Eq(a => a.Id, dataGridViewAuthor.CurrentRow.Cells[0].Value);
            ...
            if (txtboxAuthorName.Text != string.Empty && txtboxAuthorSurname.Text != string.Empty && txtboxAuthorNationality.Text != string.Empty && txtboxAuthorEmail.Text != string.Empty)
            {
                try
                {
                    var filterDefinition = Builders<AddAuthor>.Filter.Eq(a => a.Id, dataGridViewAuthor.CurrentRow.Cells[0].Value);
