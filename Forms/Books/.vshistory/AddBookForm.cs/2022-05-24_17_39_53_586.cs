            ...
            if (ADD_OR_UPDATE == 0)
            {
                if (IsValid() <= 0)
                {
                    ...
                    {   //Add book
                        ...
                        Book.Author = Convert.ToInt32(cmbboxAuthorsName.SelectedValue);
                        Book.Publisher = Convert.ToInt32(cmbboxPublisherName.SelectedValue);
                        Book.Category = Convert.ToInt32(cmbboxCategory.SelectedValue);
