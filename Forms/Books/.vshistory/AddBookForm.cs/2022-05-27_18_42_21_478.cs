        ...
        private void btnAddBook_Click(object sender, EventArgs e)
        {
            if (ADD_OR_UPDATE == 0)
            {
                try
                {
                    ...
                    Book.AUTHOR_ID = Convert.ToInt32(cmbboxAuthorsName.ValueMember);
                    Book.PUBLISHER_ID = Convert.ToInt32(cmbboxPublisherName.ValueMember);
                    Book.CAT_ID = Convert.ToInt32(cmbboxCategory.ValueMember);
