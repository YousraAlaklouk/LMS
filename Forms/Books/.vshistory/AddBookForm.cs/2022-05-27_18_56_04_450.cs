        ...
        private void btnAddBook_Click(object sender, EventArgs e)
        {
            if (ADD_OR_UPDATE == 0)
            {
                try
                {
                    ...
                    Book.AUTHOR_ID =Convert.ToString( cmbboxAuthorsName.SelectedValue);
                    Book.PUBLISHER_ID = Convert.ToString(cmbboxPublisherName.SelectedValue);
                    Book.CAT_ID = Convert.ToString(cmbboxCategory.SelectedValue);
