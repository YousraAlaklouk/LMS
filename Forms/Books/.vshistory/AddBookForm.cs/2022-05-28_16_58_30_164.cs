            ...
            else
            {
                try
                {
                    var updateDef = Builders<AddBook1>.Update
                                ...
                                .Set("AUTHOR_ID", Convert.ToString(cmbboxAuthorsName.SelectedValue))
                                .Set("PUBLISHER_ID", Convert.ToString(cmbboxPublisherName.SelectedValue))
                                .Set("CAT_ID", Convert.ToString(cmbboxCategory.SelectedValue))
