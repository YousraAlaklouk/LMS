            ...
            else
            {
                try
                {
                    var updateDef = Builders<AddBook1>.Update
                                ...
                                .Set("AUTHOR_ID", cmbboxAuthorsName.SelectedValue.ToString())
                                .Set("PUBLISHER_ID", cmbboxPublisherName.SelectedValue.ToString())
                                .Set("CAT_ID", cmbboxCategory.SelectedValue.ToString())
                                .Set("ISBN_NO", txtboxAddBookIsbn.Text.Trim())
                                .Set("QUANTITY", Convert.ToInt32(txtboxQuantity.Text))
                                .Set("EDITION", txtEdition.Text.Trim())
                                .Set("EDITORS", txtEditor.Text.Trim())
                                .Set("LANGUAGE", txtLang.Text.Trim())
                                .Set("PAGECOUNT", Convert.ToInt32(txtCount.Text))
                                .Set("DATE",BookDate.Text.ToString())
                                .Set("RATE", bunifuRating1.Value);
