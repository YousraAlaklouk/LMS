    ...
    public partial class BooksForm : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridViewBook.Rows.Count > 0)
            {
                ...
                frm_edit.txtEdition.Text = dataGridViewBook.CurrentRow.Cells[5].Value.ToString();
                frm_edit.txtEditor.Text = dataGridViewBook.CurrentRow.Cells[6].Value.ToString();
                frm_edit.txtLang.Text = dataGridViewBook.CurrentRow.Cells[7].Value.ToString();
                frm_edit.txtCount.Text = dataGridViewBook.CurrentRow.Cells[8].Value.ToString();
                frm_edit.BookDate.Value = Convert.ToDateTime(dataGridViewBook.CurrentRow.Cells[9].Value);
