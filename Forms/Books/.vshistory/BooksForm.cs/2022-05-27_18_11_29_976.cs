    ...
    public partial class BooksForm : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridViewBook.Rows.Count > 0)
            {
                ...
                frm_edit.txtboxAddBookTitle.Text = dataGridViewBook.CurrentRow.Cells[5].Value.ToString();

                frm_edit.txtboxAddBookIsbn.Text = dataGridViewBook.CurrentRow.Cells[6].Value.ToString();
                frm_edit.bunifuRating1.Text = dataGridViewBook.CurrentRow.Cells[7].Value.ToString();

                frm_edit.txtboxQuantity.Text = dataGridViewBook.CurrentRow.Cells[8].Value.ToString();
