    ...
    public partial class BooksForm : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridViewBook.Rows.Count > 0)
            {
                ...
                frm_edit.cmbboxAuthorsName.SelectedItem = dataGridViewBook.CurrentRow.Cells[4].Value.ToString();
                frm_edit.cmbboxPublisherName.SelectedItem = dataGridViewBook.CurrentRow.Cells[5].Value.ToString();
                frm_edit.cmbboxCategory.SelectedItem = dataGridViewBook.CurrentRow.Cells[6].Value.ToString();
                frm_edit.txtboxAddBookTitle.Text = dataGridViewBook.CurrentRow.Cells[7].Value.ToString();

                frm_edit.txtboxAddBookIsbn.Text = dataGridViewBook.CurrentRow.Cells[8].Value.ToString();
                frm_edit.bunifuRating1.Text = dataGridViewBook.CurrentRow.Cells[9].Value.ToString();

                frm_edit.txtboxQuantity.Text = dataGridViewBook.CurrentRow.Cells[10].Value.ToString();
                frm_edit.BookDate.Text = dataGridViewBook.CurrentRow.Cells[11].Value.ToString();

                frm_edit.txtEdition.Text = dataGridViewBook.CurrentRow.Cells[12].Value.ToString();
                frm_edit.txtEditor.Text = dataGridViewBook.CurrentRow.Cells[13].Value.ToString();
                frm_edit.txtLang.Text = dataGridViewBook.CurrentRow.Cells[14].Value.ToString();
                frm_edit.txtCount.Text = dataGridViewBook.CurrentRow.Cells[15].Value.ToString();
