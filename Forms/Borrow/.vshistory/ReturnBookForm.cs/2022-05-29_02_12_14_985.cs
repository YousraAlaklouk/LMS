...
namespace LibraryManegement.Forms
{
    ...
    /*            using (SqlConnection con = new SqlConnection(AppConnection.GetConnectionString()))
                {
                    using (SqlCommand cmd = new SqlCommand("COMBO_BORROW_BOOK", con))
                    {
                        ...
                        cmboxBookToReturn.DataSource = dtRoles;
                        cmboxBookToReturn.DisplayMember = "TITLE";
                        cmboxBookToReturn.ValueMember = "ID";
                    }
                }*/
            }
            catch (Exception ex)
