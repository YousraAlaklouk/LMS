...
namespace LibraryManegement.Forms
{
    public partial class ReturnBookForm : Form
    {
        ...
        IMongoCollection<Borrow2> BCollection;
        ...
        public ReturnBookForm()
        {
            ...
            BCollection = mongodb.GetCollection<Borrow2>("BORROWING");
            InitializeComponent();
            ...
            {
                {
                    ...
                    var filterDef = BCollection.Find(filtirDefinition).ToList();

                    dataBook.DataSource = filterDef;
                }
            }
            catch (Exception ex)
            {
