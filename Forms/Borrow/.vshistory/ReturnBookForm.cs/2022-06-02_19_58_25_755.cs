...
namespace LibraryManegement.Forms
{
    public partial class ReturnBookForm : Form
    {
        ...
        public ReturnBookForm()
        {
            ...
            BorrowCollection = mongodb.GetCollection<Borrow2>("BORROWING");
            InitializeComponent();
        ...
        public void refreshBorrowedHistory()
        {
            try
            {
                //Working without Titles
                    ...
                    var borrow = BorrowCollection.Find(filtirDefinition).ToList();
                    dataBook.DataSource = borrow;
                    
                //Trying =-------------------------------
                
                List<BsonDocument> results = BorrowCollection.Find(new BsonDocument()).ToList();
