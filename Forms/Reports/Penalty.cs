            ...
            if (rdiobtnPaid.Checked || rdiobtnUnpaid.Checked)
            {
                ...
                try
                {
...

                    {
                        ...
                        var filtirDefinition = Builders<Penallty>.Filter.Eq(a => a.CONDITION, txt.ToString());
                        var Penallty = BCollection.Find(filtirDefinition).ToList();
                        dataGridView.DataSource= Penallty;
                    ...
                    if (rdiobtnUnpaid.Checked)
                    {
                        ...
                        var filtirDefinition = Builders<Penallty>.Filter.Eq(a => a.CONDITION, txt2.ToString());
